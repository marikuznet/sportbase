<template>
    <div class="modal fade sb-modal" :id="id" tabindex="-1" role="dialog" :ref="id" aria-hidden="true"
         data-backdrop="static" :class="modal_class" data-toggle="modal">
        <div :class="modal_class">
            <div class="modal-dialog" role="document" style="padding: 0 1rem">
                <div class="modal-content">
                    <div class="modal-header align-items-center">
                        <h3 class="modal-title text-center w-100">{{ title }}</h3>
                        <button type="button" class="close" :data-modal="id" @click="closeModal">
                    ...
                    <div class="sb-modal-footer pl-2 pr-2">
                        <slot name="footer">
