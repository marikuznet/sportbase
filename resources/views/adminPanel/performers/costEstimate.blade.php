        ...
        <div class="settings-performers">
            <div class="container row top d-none d-lg-flex settings-performers__button">
                ...
                <a href="{{route('admin.performers.price')}}" class="col-2 p-0">
                    <button
                        class="w-100 p-2 settings-performers__button_active" name="price">Сметы и счета
                    </button>
                </a>
            ...
            <div class="p-0 position-relative settings-performers__content">
                <div class="container row pt-3">
                    <div class="col-2">
                        <h4 class="title fw-bold pb-2 addInform">Сметы и счета</h4>
                    </div>
                    <div class="col-2"><a href="{{route('admin.performers.deals')}}">НА СОГЛАСОВАНИИ (2)</a></div>
                    <div class="col-2"><a href="{{route('admin.performers.applications')}}">В ИСПОЛНЕНИИ (123)</a></div>
                    <div class="col-2">АРХИВНАЯ (123)</div>
                </div>
                    ...
                    <div class="overflow-auto">
                        <table class="table table-responsive">
                            ...
                            <tr>
                                ...
                                <td>12,345.67 руб</td>
                                <td><span style="color: #1e3041">Завершена (успешно)</span></td>
                                <td width="10%">
                                    <a href="">Подробнее</a>
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td>12,345.67 руб</td>
                                <td><span style="color: red">Завершена (с арбитражем)</span></td>
                                <td width="10%">
                                    <a href="">Подробнее</a>
                                </td>
                            </tr>
